...
<div class="form-row">
	<div class="form-group col-xl-6 col-md-6">
		<p>Montant mensuel: <strong> <?php echo number_format($monthly, 2)." "."€ "?></strong></p>
		<p>Penalité: <strong> <?php echo number_format($add, 2)." "."€ "?></strong></p>
		<p>Montant à payer: <strong> <?php echo number_format($monthly+$add, 2)." "."€ "?></strong></p>
	</div>
	<div class="form-group col-xl-6 col-md-6">
		<label>Montant<label>
